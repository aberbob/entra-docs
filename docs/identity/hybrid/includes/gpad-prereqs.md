...
The following is supported:
  - Only cloud created [Security groups](../../../fundamentals/concept-learn-about-groups.md#group-types) are supported. See the attribute filtering [default security grouping](../cloud-sync/how-to-attribute-mapping-entra-to-active-directory.md#the-default-security-grouping) for more details.
